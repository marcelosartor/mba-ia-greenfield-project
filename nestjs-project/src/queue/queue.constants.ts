...
// The sweeper runs every 15 minutes (~96 jobs a day), so its finished jobs would
// pile up in Redis, which runs with `noeviction`. Keep a day of history for
// inspection and drop the rest; jobs made by the scheduler inherit these.
